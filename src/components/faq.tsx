      ...
      {faqs.map((faq, index) => (
        <div key={index} className="mb-4">
          <div
            ...
            className="flex items-center justify-between p-4 cursor-pointer bg-gray-200 dark:bg-gray-800 rounded-lg"
          >
          ...
          <div
            ...
            } mt-2 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg`}
          >
