...
const ContactWay: React.FC<ContactWayProps> = ({ way }) => (
  <a
    href={way.url}
    className={`contact-way flex bg-gray-400 rounded-lg
            shadow-md hover:shadow-xl flex-wrap sm:w-50
            sm:h-20 px-4 py-3 transition duration-300 ease-in-out
            transform hover:-translate-y-1 flex-row sm:flex-col
            sm:px-4 rtl:space-x-reverse space-x-1`}
    target="_blank"
    rel="noreferrer"
  >
